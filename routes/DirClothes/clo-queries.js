let queries = {
  ...
  update: "UPDATE Clothes SET name = ?, category = ?, size = ?, price = ?, purchaseCost = ?, stock = ?, Manufacturers_idManufacturer = (SELECT idManufacturer FROM Manufacturers WHERE name = ?) WHERE idClothes = ?;",
